                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control test_form_input" id="UpdateProductCategory">
                                    </div>
                                    <div class="col-md-6">
                                        <div class="d-flex align-items-center mt-3">
                                            ...
                                            <div>
                                                ...
                                                <input oninput="updatePreview(this)" type="file" class="form-control" id="UpdateImage">
...
<script>
    ...
    async function FillUpUpdateForm(id) {
        try {
            ...
            showLoader();
            let res = await axios.post("api/product-category-by-id", { id: id.toString() }, HeaderToken());
            hideLoader();

            let data = res.data.rows;
            document.getElementById('UpdateProductCategory').value = data.category_name;
            // Update the preview with the existing image URL
            updatePreview(document.getElementById('UpdateImage'), data.category_img);
        } catch (e) {
    ...
    async function Update() {
        try {
            ...
            let UpdateImage = document.getElementById('UpdateImage').files[0];
            ...
            formData.append('category_name', UpdateProductCategory);
            ...
            let res = await axios.post("api/update-product-category", formData, config);
            hideLoader();
