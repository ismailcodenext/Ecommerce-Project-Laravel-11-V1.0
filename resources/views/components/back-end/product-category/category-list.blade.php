        ...
        <div class="col-md-12 col-sm-12 col-lg-12">
            <div class="wrapper">
                <div class="row justify-content-between ">
                    ...
                    <div class="align-items-center col">
                        <button data-bs-toggle="modal" data-bs-target="#create-modal" class="float-end create_btn">Create Category</button>
                    </div>
                </div>
...
<script>
    ...
    async function getList() {
        ...
        try {
            ...
            res.data['ProductCategoryData'].forEach(function (item, index) {
                let row = `<tr>
                        <td>${index + 1}</td>
                        <td><img style="width: 60px; height: auto" alt="" src="${item['category_img']}"></td>
